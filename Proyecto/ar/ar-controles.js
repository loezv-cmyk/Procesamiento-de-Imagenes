...
document.getElementById("btnMas").onclick = () => {
    ...
    if(!paisActivo){
        console.log("No hay país activo");
        return;
    }

    // rutas hacia páginas
    const rutas = {
        mexico: "../paises/mexico.html",
        corea: "../paises/corea.html",
        japon: "../paises/japon.html",
        sudafrica: "../paises/sudafrica.html",
        tunez: "../paises/tunez.html"
    };

    const destino = rutas[paisActivo];
